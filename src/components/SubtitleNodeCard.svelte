...
<div>
  ...
  >
    <!-- segment info -->
    <div
      class="w-1/6 bg-blue-200 flex flex-col justify-center items-center text-xs rounded-lg font-mono"
    >
    ...
    <div class="w-full pl-2 flex flex-col justify-center py-2">
      ...
      {:else}
        <div
          ...
          class="h-full py-4 focus:border-blue-400 focus:border-2 focus:outline-none rounded transition-colors"
